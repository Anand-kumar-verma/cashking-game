      ...
      <Box sx={{ width: '100%', padding: '16px' }}>
        <TableContainer component={Paper} sx={{ backgroundColor: '#333', borderRadius: '10px' }}>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell className="f17" sx={{ padding: '5px', lineHeight: '15px', py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Continuous attendance</TableCell>
                <TableCell className="f17" sx={{ padding: '5px', lineHeight: '15px', py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Accumulated amount</TableCell>
                <TableCell className="f17" sx={{ padding: '5px', lineHeight: '15px', py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Attendance bonus</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map((row, index) => (
