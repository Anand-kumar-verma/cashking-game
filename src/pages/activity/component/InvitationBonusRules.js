    ...
    <Layout header={false} footer={false}>
      <Box sx={{ py: '12px', background: bgcolorlight }}>
        <Box className="fcsb w95" >
          ...
          <Typography sx={{ color: 'black', width: '20%' }}></Typography>
        </Box>
      </Box>


      <Typography variant="body1" className=' fp13 fw500 w95' mt={1}>Invite friends and recharge to get additional platform rewards!</Typography>
      <Typography variant="body1" className=' fp13 fw500 w95' mt={1}>After being claimed, the rewards will be directly distributed to the wallet balance within 10 minutes.</Typography>
      ...
      <Box sx={{ width: '100%', padding: '16px' }}>
        <TableContainer component={Paper} sx={{ backgroundColor: '#333', borderRadius: '10px' }}>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell sx={{ padding: 0, py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Invite account</TableCell>
                <TableCell sx={{ padding: 0, py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Deposit amount</TableCell>
                <TableCell sx={{ padding: 0, py: 1, textAlign: 'center', borderBottom: 'none', color: '#fff', fontWeight: 600, backgroundColor: '#ff5959' }}>Bonus</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map((row, index) => (
                <TableRow
                  key={index}
                  sx={{
                    backgroundColor: index % 2 === 0 ? '#ff9191' : '#ff6666',
                  }}
                >
