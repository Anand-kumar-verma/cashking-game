...
import { bggrad, bgtan, zubgback, zubgtext } from "../../../Shared/color";
...
export default function Ticketgenerate() {
  ...
  return (
    <Layout>
      <Container sx={{ background: zubgback, width: '100%', height: '100vh', overflow: 'auto', mt: 8 }}>
        <div className="flex justify-between w-full items-center  px-2 pt-6  ">
          <div className="grid grid-cols-2 gap-1 items-center w-[400px] p-5">
            <span className="col-span-2 justify-end">
              <div className="flex justify-between">
                <span className="font-bold text-black !text-xl my-3 !text-center">Ticket Generate</span>
              </div>
            </span>
            <span className="!text-black !my-3 !text-xl">
              Select Type*
            </span>
            <TextField
              id="type"
            ...
            <span className="!text-black !my-3 !text-lg">Attachment*</span>
            <div>
              <input
                type="file"
                id="myfile"
                ...
                required
              />
              <p className="!text-black !text-[10px]">File size should be less than 10MB</p>
            </div>
            <span className="!text-black !my-3 !text-lg">Description*</span>
            <textarea
              ...
              onChange={fk.handleChange}
              className="!w-[100%]  !text-sm  !text-center !text-black pt-4 !my-3"
            />
        ...
        <p className="!text-black text-center !-mt-16 ">Ticket Raised History </p>
        {ticket?.map((i, index) => {
          return (
            <Box
              key={index}
            ...
            >
              ...
              >
                <Box>
                  <Typography className="!bg-[#272726] !text-black rounded px-2 py-1 !flex justify-center">
                    Ticket
                  </Typography>
                </Box>
                <Box
