        ...
        <Layout header={false}>
            <Container sx={{ background: theme.palette.secondary.light, width: '100%', padding: '10px', }}>
                ...
                <Stack direction="row" justifyContent={"space-between"} className='!mt-5 !mx-3 ' sx={{ pb: 2 }}>
                    <Box className="!border !w-1/2 !p-2 mr-4 !flex !justify-between " sx={{ color: 'black' }}
                        onClick={toggleDrawer} >
                        Level {selectedLevel}   <ArrowDropDown />
                    </Box>
                    <Box className="!border !w-1/2 !p-2 !flex !justify-between" sx={{ color: 'black' }}
                ...
                <Box sx={style.subcordinateBox} className="!mb-20">
                    ...
                    {data?.map((item) => {
                        return (<Box sx={{ background: '#e7e7e7', borderRadius: '5px', padding: '5px', mb: 2, mt: 2, }}>
...
const style = {
    ...
    subcordinatelist: {
        textAlign: "center",
        "&>p:nth-child(1)": { color: 'black', fontSize: "13px" },
        "&>p:nth-child(2)": { color: 'black', fontSize: "13px" },
        mb: 1,
    },
    subcordinateBox: {
        width: "100%",
