            ...
            <Container sx={{ background: theme.palette.secondary.main, width: '100%', minHeight: '100vh', }}>
                ...
                {data?.map((item) => {
                    return <div className="flex flex-col justify-center gap-1 mt-5 !mb-20 m-2" >
                        ...
                        <div className="flex flex-col  text-gray-500 justify-center shadow-xl rounded-lg    p-3" style={{ background: '#e7e7e7', color: 'black' }}>
                            <p className='text-gray-500' style={{ color: 'black' }}>Settlement successfully </p>
                            <p className='text-gray-500' style={{ color: 'black' }}>{item?.satelment_date || 0}</p>
                            The commission has been automatically credited to your balance
                        </div>
                        <div className="flex justify-between shadow-xl  rounded-lg    p-3" style={{ background: '#e7e7e7', color: 'black' }}>
                            <p className='text-gray-400' style={{ color: 'black' }}>Number of bettors</p>
                            <p className='font-bold'>{item?.num_of_betters || 0}</p>
                        </div>
                        <div className="flex justify-between shadow-xl  rounded-lg    p-3" style={{ background: '#e7e7e7', color: 'black' }}>
                            <p className='text-gray-400' style={{ color: 'black' }}>Bet Amount</p>
                            <p className='font-bold'>{item?.better_amount || 0}</p>
                        </div>
                        <div className="flex justify-between shadow-xl  rounded-lg    p-3" style={{ background: '#e7e7e7', color: 'black' }}>
                            <p className='text-gray-400' style={{ color: 'black' }}>Commission Payout</p>
                            <p className='font-bold'>{item?.total_commission_user || 0}</p>
                        </div>
                        <div className="flex justify-between shadow-xl  rounded-lg    p-3" style={{ background: '#e7e7e7', color: 'black' }}>
                            <p className='text-gray-400' style={{ color: 'black' }}>Date</p>
