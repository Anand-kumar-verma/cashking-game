...
import { normalinput, passwordinput } from "../../Shared/Commom";
    ...
    <Layout header={false}>
      ...
      >
        ...
        >
          ...
          >
            <Box component="img" src={balance} width={40}></Box>
            <Typography
              variant="body1"
              sx={{
                fontSize: "16px ",
        ...
        <Box>
          <Box className="fccsb w95" >
            {/* <Box
              sx={{ width: "48%", background: "#1B0E1F", borderRadius: "5px", ml: '26%', }}
              className="fccc"
              component={NavLink}
          ...
          >
            {result?.length === 0 ? (
              ...
              <>
                <p className="text-black "> Account No :  {result?.[0]?.account}</p>
                <p className="text-black ">IFSC Code  :  {result?.[0]?.ifsc}</p>
            ...
            <Stack direction="row" sx={{ alignItems: "end", mb: "20px" }}>
              ...
              <Typography
                variant="body1"
                sx={{ fontSize: "15px ", color: "black", ml: "10px", pt: 3 }}
              >
                Withdrawal amount
              </Typography>
            </Stack>
            <Box mt={2}>
              <FormControl fullWidth sx={{ mt: "10px" }}>
                <Stack direction="row" className="loginlabel">
                  <Typography variant="h3" sx={{ color: "black" }}>
                    Enter amount <span className="!text-black-600">*</span>
                  </Typography>
                </Stack>
                <TextField
                  id="amount"
              ...
              <Box mt={3}>
                <FormControl fullWidth>
                  <Stack direction="row" className="loginlabel">
                    <Typography variant="h3" sx={{ color: "black" }}>
                      Password <span className="!text-black-600">*</span>
                    </Typography>
                  </Stack>
                  <OutlinedInput
                    className="abcd"
