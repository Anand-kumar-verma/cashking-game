...
import user from "../../../assets/images/rec_ins.png";
...
import pay from "../../../assets/wallet-money-svgrepo-com (3).svg";
import bg from "../../../assets/img/download.png";
import Layout from "../../../component/Layout/Layout";
import { endpoint } from "../../../services/urls";
import theme from "../../../utils/theme";
import UsdtQR from "./UsdtQR";
import { passwordinput } from "../../../Shared/Commom";
      ...
      >
        <Stack direction="row" sx={{ alignItems: "center", mb: "20px" }}>
          ...
          <Typography
            variant="body1"
            color="initial"
            sx={{ fontSize: "15px ", color: "black !important", ml: "10px" }}
          >
            {" "}
        ...
        >
          <Stack direction="row" sx={style.rechargeinstext}>
            ...
            <Typography
              variant="body1"
              sx={{ color: "black !important", fontSize: "12px" }}
            >
    ...
    <Layout header={false}>
      ...
      >
        ...
        <Box className="fccsb w95" mt={2}>
          {/* <Box
            sx={{ width: "48%", background: "#FFFFFF", borderRadius: "5px", ml: '26%', }}
            className="fccc"
            component={NavLink}
            ...
            >
              ...
              >
                <OutlinedInput
                  ...
                  sx={{ ...passwordinput, width: '100%', '&>input': { textAlign: 'center' }, }}
                  startAdornment={
                    <InputAdornment position="start">
                      <Typography variant="body1" color="initial" sx={{ color: 'red', fontSize: '30px', fontWeight: '500', borderRight: '1px solid gray', paddingRight: '10px', lineHeight: '25px' }}>₹</Typography>
                    </InputAdornment>
                  }
                  type="number"
                  id="amount"
