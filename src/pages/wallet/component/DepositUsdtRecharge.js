          ...
          >
            ...
            <FormControl fullWidth sx={{ my: "10px" }}>
              ...
              <TextField
                ...
                className="!w-[100%] !bg-[#fff] !text-[#000000] !mt-5"
                select
                size="small"
              >
                {Array.isArray(res) &&
            ...
            <span className="!text-black !text-lg ">Receipt*</span>
            <input
              type="file"
              id="file"
              name="file"
              ...
              required
            />
            <span className="text-black text-lg !my-5">Transaction hash </span>
            <TextField
              id="utr_no"
              name="utr_no"
              ...
              className="!w-[100%] !bg-[#ffffff] !text-[#000000] !mt-2"
              size="small"
            ></TextField>
            <Stack
              direction="row"
