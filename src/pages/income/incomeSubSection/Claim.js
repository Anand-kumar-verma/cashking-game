  ...
  return (
    <Layout header={false}>
      ...
      >
        ...
        <Box sx={style.header}>
          <Box component={NavLink} onClick={goBack}>
            <KeyboardArrowLeftOutlinedIcon sx={{ color: 'white !important' }} />
          </Box>
          <p style={{ color: bgtan }}>Invitation Bonus  </p>
          <Box></Box>
        </Box>
          ...
          <Table sx={{ background: bgdarkgray, boxShadow: zubgshadow }}>
            <TableHead>
              <TableRow>
                <TableCell
                  sx={{ color: "black" }}
                  className=" !font-bold !border !text-xs !border-r  !text-center !border-b !border-black"
                >
                  S.No
                </TableCell>
                <TableCell
            ...
            <TableBody>
              {visibleRows?.map((i, index) => (
                <TableRow key={i?.id}>
                  <TableCell
                    sx={{ color: "black" }}
                    className="!border !border-r !text-xs !text-center !mt-5  !border-b !border-black"
                  >
                    {index + 1}
                  </TableCell>
                  <TableCell
                    sx={{ color: "black" }}
                    className="!border !border-r !text-xs !text-center  !border-b !border-black"
                  >
