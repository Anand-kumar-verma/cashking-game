    ...
    >
      <Box mt={3} >
        <Box sx={{ ...flexcenterstart, my: 1, }}>
          <Box component={"img"} src={phoneic} sx={{ width: '20px' }}></Box> <Typography variant="body1" ml={1} sx={{ color: 'black' }}> Phone number</Typography>
        </Box>
        <FormControl fullWidth>
          <Box sx={{ ...flexbetween, }}>
            ...
            <TextField
              ...
              sx={{
                ...normalinput, width: '80%', border: 'none',
                '&:focus': {
      ...
      <Box  >
        <FormControl fullWidth >
          <Box sx={{ ...flexcenterstart, mt: 4, mb: 1, }}>
            <Box component={"img"} src={passwordic} sx={{ width: '23px' }} /><Typography variant="body1" ml={1} sx={{ color: 'black' }}> Password</Typography>
          </Box>
          <OutlinedInput
            id="pass"
            className="funp13"
            ...
            onKeyDown={(e) => e.key === "Enter" && fk.handleSubmit()}
            sx={{
              ...passwordinput, width: '100%', width: '100%',
