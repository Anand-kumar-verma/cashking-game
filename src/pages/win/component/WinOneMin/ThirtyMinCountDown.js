...
const ThirtyMinCountDown = ({ fk, setBetNumber }) => {
    ...
    React.useEffect(() => {
        const handleOneMin = (onemin) => {
            ...
            const time_to_be_intro_mid = t > 0 ? 60 - t : t;
            const time_to_be_intro = time_to_be_intro_mid >= 30 ? time_to_be_intro_mid - 30 : time_to_be_intro_mid
            ...
            if (time_to_be_intro === 0) {
                ...
                client.refetchQueries("gamehistory_wingo_4");
                setTimeout(() => {
...
export default ThirtyMinCountDown;
