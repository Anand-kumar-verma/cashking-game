        ...
        <Table sx={{ maxWidth: 400, color: "white" }} className="wintable" aria-label="simple table">
          ...
          <TableBody>
            {visibleRows?.map((i) => {
              return (
                <TableRow sx={{}}>
                  <TableCell className="!text-black" sx={{ fontsize: ' 13px', borderBottom: '1px solid transparent', p: 0, }}>
                    <span
                  ...
                  <TableCell className="!text-black" sx={{ fontsize: ' 15px !important', borderBottom: '1px solid transparent', p: 0, }}>
                    <span
                      className={`
fp25 fw700
                ${(i?.number === "0" &&
                ...
                `}
                  ...
                  <TableCell sx={{ fontSize: '12px', fontWeight: '400', color: 'black', borderBottom: '1px solid transparent', p: 0, }}
        ...
        <Box className="paginationTable !w-full ">
          <TablePagination
            sx={{
              background: bggrad, color: 'white', overflow: 'hidden',
              mb: 5,
            }}
